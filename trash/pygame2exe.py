...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "newsputnik.py"
 
        #Name of program
        self.project_name = "Sputnik"
        ...
        #Auhor of program
        self.author_name = "Maxim Kovalev"
        self.author_email = "maxim.kovalev@2007.auditory.ru"
        self.copyright = "Copyright (c) 2013 Maxim Kovalev."
 
        #Description
        self.project_description = "2D spaceflight simulator"
