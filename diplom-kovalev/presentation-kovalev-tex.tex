...
\title[GSM-localization of vehicles]{Tracking public transportation vehicles by cellular network signals}
\subtitle{\texttt{http://svn.auditory.ru/repos/tatmon/}}
\author[Maxim Kovalev]{By Maxim Kovalev \\ \texttt{maxim.kovalev@sv.cmu.edu}}
\institute[CMU]{Carnegie Mellon University, PhD sutudent}
\date{August 2013}
